# genpark-enterprise-semantic-kernel-plugin-connector-skill
...
> **GenPark AI Agent Skill** -- Enterprise semantic kernel plugin connector and stepwise planner (Semantic Kernel style)
